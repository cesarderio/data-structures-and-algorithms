...
class Graph {
  ...
  addDirectedEdge(startVertex, endVertex, weight = 0){
    // find the vertex we want to connect and grab its edge array
  ...
  getNodes(){
    return this.adjacencyList.keys; // maybe: Objects.keys maybe?
  }
  ...
  breadthFirst(root, callback){
    ...
    while(queue.length){
      ...
      // if a callback has been passed in, the we "do the thign"
